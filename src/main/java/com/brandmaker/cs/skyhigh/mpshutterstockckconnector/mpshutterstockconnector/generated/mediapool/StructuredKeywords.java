...
/**
 * <p>Java class for structuredKeywords complex type.
 * 
...
public class StructuredKeywords {
     ...
     * This is why there is not a <CODE>set</CODE> method for the structuredKeyword property.
     * 
     * <p>
    ...
    public List<NameAndIdItem> getStructuredKeyword() {
        if (structuredKeyword == null) {
            structuredKeyword = new ArrayList<NameAndIdItem>();
        }
